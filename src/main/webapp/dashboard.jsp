...
<div class="m-4 p-4 width-medium">
    ...
    <div class="m-4 p-4 border-dashed">
        ...
        <c:forEach items="${planDayNamesSet}" var="DAY">
        <table class="table">
            <thead>
            <tr class="d-flex">
            ...
            <c:forEach items="${plan}" var="plan">
                <c:if test="${plan.dayName.equals(DAY)}">
                <tbody>
                <tr class="d-flex">
                    <td class="col-2">${plan.mealName}</td>
                    <td class="col-8">${plan.recipeName}</td>
                    <td class="col-2">
                        <a href="/app/recipeDetails?id=${plan.recipeId}" type="button" class="btn btn-primary rounded-0">Szczegóły</a>
                    </td>
                </tr>
                </tbody>
                </c:if>
