                    ...
                    <div class="mt-4 ml-4 mr-4">
                        ...
                        <table class="table borderless">
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-7"><textarea name="description" id="description" class="w-100 p-1" rows="5"></textarea></td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2">Przygotowanie (minuty)</th>
                                <td class="col-3">
                                    <input name="preparationTime" id="preparationTime" class="p-1" type="number" value="">
                                </td>
                            </tr>
                            </tbody>
                        </table>
