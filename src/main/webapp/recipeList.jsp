                    ...
                    <c:forEach items="${recipeList}" var="recipe">
                        <tr class="d-flex">
                            ...
                            <td class="col-2 d-flex align-items-center justify-content-center flex-wrap">
                                <a href="/app/recipe/delete?recipeId=${recipe.id}" class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
                                <a href="/app/recipeDetails?id=${recipe.id}" class="btn btn-info rounded-0 text-light m-1">Szczegóły</a>
