            ...
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                ...
                <div class="schedules-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" id="choosePlan" name="choosePla">
                                    <c:forEach items="${choosePlan}" var="choosePlan">
                                        <option value="${choosePlan.id}">${choosePlan.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control" value="" id="number" name="number" placeholder="Numer posiłki">
                            </div>
                        </div>
                        <div class="form-group row">
